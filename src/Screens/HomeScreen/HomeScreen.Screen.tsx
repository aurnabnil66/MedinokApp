...
const HomeScreen: FC = () => {
  ...
  const deleteMedicineItem = (medicineId: any) => {
    ...
    if (filtered_Schedule_List.length > 0)
      deleteSchedule(filtered_Schedule_List[0].notificationId);
                    ...
                    <TouchableOpacity
                      ...
                      <View style={styles.medicineDoseProperties}>
                        ...
                        <View style={styles.doseTimePosition}>
                          ...
                          <TouchableOpacity
                            onPress={() => deleteMedicineItem(medicine)}>
