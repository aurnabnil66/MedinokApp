...
public class Module extends ReactContextBaseJavaModule {
    ...
    public void get(String alarmUid, Promise promise) {
        try {
            ...
            e.printStackTrace();
            promise.reject("GET_ALARM_ERROR", e.getMessage());
        }
    }
    ...
    public void getAll(Promise promise) {
        try {
            ...
            WritableNativeArray serializedAlarms = serializeAlarms(alarms);
            promise.resolve(serializedAlarms);
        } catch (Exception e) {
            e.printStackTrace();
            promise.reject("GET_ALL_ALARMS_ERROR", e.getMessage());
        }
    }
    ...
    private WritableNativeArray serializeAlarms(List<Alarm> alarms) {
        WritableNativeArray array = new WritableNativeArray();
        for (Alarm alarm : alarms) {
            array.pushMap(serializeAlarmObject(alarm));
        }
        return array;
    }
}